        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    <li class="xn-logo">
                        <a href="<?php echo base_url(); ?>user/Dashboard">Expert System</a>
                    ...
                    <li class="xn-profile">
                        ...
                        <div class="profile">
                            ...
                            <div class="profile-data">
                                ...
                                <div class="profile-data-title"><?php echo $value->nama_lengkap;?></div>
                            </div>
                            <?php
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>user/Dashboard"><span class="fa fa-desktop"></span> <span class="xn-text">Dashboard</span></a>                        
                    </li>   
                     <li class="xn-openable">
                        <a href="index.html"><span class="fa fa-user"></span> <span class="xn-text">Profile</span></a>   
                        <ul>
                            <li><a href="<?php echo base_url(); ?>user/profile"><span class="fa fa-image"></span>View Profile</a></li>
                            <li><a href="<?php echo base_url(); ?>user/profile/edit_profile"><span class="fa fa-pencil"></span>Edit Profile</a></li>
                        </ul>                     
                    </li>         
                    <li class="xn-openable">
                        <a href="#"><span class="fa fa-users"></span> <span class="xn-text">Pemeriksaan</span></a>
                        <ul>
                            <li><a href="<?php echo base_url(); ?>user/periksa/list_periksa"><span class="fa fa-users"></span>Transaksi Pemeriksaan</a></li>      
