                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="post" <?php echo form_open_multipart('user/profile/update_profile');?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" value="<?php echo $profile['username'];?>"  disabled=disabled class="form-control" name="username" >
                                                <input type="hidden" value="<?php echo $profile['username'];?>"  name="username" >
                                            </div>                                            
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                  <input type="text" value="<?php echo $profile['nama_lengkap'];?>"  class="form-control" name="nama"  >
                                            </div>                                            
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                               <input type="text" value="<?php echo $profile['alamat_lengkap'];?>"  class="form-control" name="alamat"  >
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                      <div class="form-check form-check-inline">
                                                          <label class="form-check-label">
                                                            <input class="form-check-input" type="radio" name="gender" <?php echo ($profile['gender']=="L")?'checked':''?> id="inlineRadio1" value="L"> Laki - Laki
                                                          </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                          <label class="form-check-label">
                                                            <input class="form-check-input" type="radio" name="gender" <?php echo ($profile['gender']=="P")?'checked':''?> id="inlineRadio2" value="P"> Perempuan
                                                          </label>
                                                        </div>
                                            </div>                                            
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                   <input type="text" value="<?php echo $profile['tempat'];?>"  class="form-control" name="tempat"  >
                                            </div>                                            
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                   <input type="date" value="<?php echo $profile['tgl_lahir'];?>"  class="form-control" name="tgl_lahir"  >
                                            </div>                                            
                                            <span class="help-block">Masukan no hp/telepon</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                   <input type="text" value="<?php echo $profile['no_hp'];?>"  class="form-control" name="hp"  >
                                            </div>                                            
                                            <span class="help-block">Masukan no hp/telepon</span>
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <input type="text" value="<?php echo $profile['email'];?>"  class="form-control" name="email"  >
