                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="btn-group"><a href="<?php echo base_url(); ?>operator/User/add_User"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Data User"><i class="fa fa-plus"></i>Tambah Data User</a></div>                              
                                    ...
                                    <table class="table datatable">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo 
                                                    '<div class="btn-group">
                                                    <a href="'.base_url().'operator/User/view_User/?username='.$op['username'].'" class="btn btn-info" role="button" data-toggle="tooltip" title="View"><i class="glyphicon glyphicon-zoom-in"></i></a>
                                                    </div>
                                                     <a href="'.base_url().'operator/User/edit_User/?username='.$op['username'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                                    <span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'operator/User/hapus_User/?username='.$op['username'].'">
