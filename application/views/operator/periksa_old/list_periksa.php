                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="btn-group"><a href="<?php echo base_url(); ?>operator/periksa/add_periksa"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Data periksa"><i class="fa fa-plus"></i>Tambah Data periksa</a></div>
                                  <div class="btn-group"><a href="<?php echo base_url(); ?>operator/periksa/update_all_hasil"  class="btn btn-default" role="button" data-toggle="tooltip" title="Update Semua Data Periksa"><i class="fa fa-refresh"></i>Update Semua Hasil Periksa</a></div>                                     
                                ...
                                <div class="panel-body">
                                    <table class="table datatable">
                                        <thead>
                                            <tr>
                                                <th width="5%">No</th>
                                                <th width="15%" align="center">User</th>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $no++;?></td>
                                                <td>
                                                <?php $variabel=$op['id_user'];
                                                foreach ($data_user->result_array()  as $op2) {
                                                  if($op2['id_user']==$variabel){
                                        ...
                                        <!--   <td><?php $variabel=$op['id_user'];
                                                ...
                                                <td>
                                                    ...
                                                    echo 
                                                    '<div class="btn-group">
                                                       <a href="'.base_url().'operator/periksa/hasil_periksa/?id_periksa='.$op['id_periksa'].'" class="btn btn-success" role="button" data-toggle="tooltip" title="View Hasil"><i class="glyphicon glyphicon-zoom-in"></i></a>';
                                                    ...
                                                    '<div class="btn-group">
                                                     ...
                                                     <?php echo '<a href="'.base_url().'operator/periksa/edit_periksa/?id_periksa='.$op['id_periksa'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                                    <span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'operator/periksa/hapus_periksa/?id_periksa='.$op['id_periksa'].'">
