                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="post" <?php echo form_open('operator/profile/update_password');?>
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer">
                                    ...
                                    <button type="submit" onclick="return Validate()" class="btn btn-primary pull-right">Update</button>
                                </div>
                            </div>
                            </form>
