        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    <li class="xn-logo">
                        <a href="<?php echo base_url(); ?>admin/dashboard">Expert System</a>
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>operator/Dashboard"><span class="fa fa-desktop"></span> <span class="xn-text">Dashboard</span></a>                        
                    </li>   
                     <li class="xn-openable">
                        <a href="index.html"><span class="fa fa-user"></span> <span class="xn-text">Profile</span></a>   
                        <ul>
                            <li><a href="<?php echo base_url(); ?>operator/profile"><span class="fa fa-image"></span>View Profile</a></li>
                            <li><a href="<?php echo base_url(); ?>operator/profile/edit_profile"><span class="fa fa-pencil"></span>Edit Profile</a></li>
                        </ul>                     
                    </li>  
                    <li class="xn-openable">
                        <a href="#"><span class="fa fa-users"></span> <span class="xn-text">Master Data</span></a>
                        <ul>
                            <li><a href="<?php echo base_url(); ?>operator/user/list_user"><span class="fa fa-users"></span>Data Users</a></li>
                        </ul>
                    </li>             
                    <li class="xn-openable">
                        <a href="#"><span class="fa fa-users"></span> <span class="xn-text">Pemeriksaan</span></a>
                        <ul>
                            <li><a href="<?php echo base_url(); ?>operator/periksa/list_periksa"><span class="fa fa-users"></span>Transaksi Pemeriksaan</a></li>      
                            <li><a href="<?php echo base_url(); ?>operator/kesimpulan/get_table_kesimpulan"><span class="fa fa-users"></span>Kesimpulan Hasil Pemeriksaan</a></li>      
                        </ul>
                    </li>
                </ul>
                <!-- END X-NAVIGATION -->
