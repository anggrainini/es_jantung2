                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="post" <?php echo form_open('operator/periksa/add_periksa');?> 
                                ...
                                <div class="panel-body form-group-separated">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            ...
                                            <option value="">&nbsp;</option>
                                             <?php   foreach($data_user->result_array() as $op)
                                            {
                                            ?>
                                            <option value="<?php echo $op['username'];?>"><?php echo $op['nama_lengkap'];?></option>
                                            <?php
                                            }
                                            ?>
                                            </select>
