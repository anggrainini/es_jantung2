...
<html lang="en" class="body-full-height">
    ...
    <body>
        ...
        <a href="<?php echo base_url(); ?>home" class="btn btn-primary text-capitalize text-white">Back to Homepage</a>  
            <div class="login-box animated fadeInDown">
                ...
                <div class="login-body">
                    ...
                    <div class="login-subtitle">
                        Don't have an account yet? <a href="<?php echo base_url(); ?>global/register">Create an account</a>
                    </div>
                    </form>
                </div>
                <div class="login-footer">
                    <div class="pull-left">
                        &copy; 2018 Anggraini Diah Puspitaningrum 
                    </div>
