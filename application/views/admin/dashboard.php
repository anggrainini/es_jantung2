      ...
      <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-default widget-item-icon" onclick="location.href='<?php echo base_url(); ?>admin/periksa/list_periksa';">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-default widget-item-icon" onclick="location.href='<?php echo base_url(); ?>admin/user/list_user';">
                                <div class="widget-item-left">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body faq">
                                    <div class="faq-item">
                                        ...
                                        <div class="faq-text">
                                            <h5>Dashboard</h5>
                                            <p>Berisi tampilan awal setelah admin login ke dalam sistem.</p>
                                    ...
                                    <div class="faq-item">
                                        ...
                                        <div class="faq-text">
                                            ...
                                            <h5>Kesimpulan Data Pemeriksaan</h5>
                                            <p>Berisi tabel data pemeriksaan dan hasil pemeriksaan dari semua data yang telah di inputkan</p>
