                            ...
                            <div class="panel panel-default tabs">                            
                                ...
                                <div class="panel-body tab-content">
                                                     ...
                                                     <?php foreach($data_user->result_array() as $user)
                                                        {
                                                            ...
                                                            if($user['username']== $periksa['username']){
                                                        ?>
                                    ...
                                    ;?> 
                                                ...
                                                <div class="profile-data">
                                                                ...
                                                                <div class="profile-data-title"><?php echo $user['nama_lengkap'];?></div>
                                                            </div>
                                        ...
                                        <div class="panel-body list-group">
                                           <div class="panel-body">
                                            <table class="table table-hover">
                                                <tbody>
                                                    <tr>
                                                        <td><span class="fa fa-user">Username</span></td>
                                                        <td><?php echo $periksa['username'];?></td>
                                                    </tr>
                                                      <tr>
                                            ...
                                            <table class="table table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th  class="col-md-2">Treatment HT</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th class="col-md-2">Smoker</th>
                                                        <th class="col-md-2">Gula Darah</th>
                                                        <th class="col-md-2">Diabet</th>
                                                        <th class="col-md-2">BMI</th>
                                                    </tr>
                                                </thead>
                                                 <tbody>
                                                    <tr>
                                                         <td><?php if($periksa['var_smoker']=='1'){
                                                            echo "YA";
                                                        }
                                                      else{
                                                            echo "TIDAK";
                                                      };?> </td>
                                                        <td><?php echo $periksa['GD'];?></td>
                                                        <td><?php if($periksa['var_GD']=='1'){
                                                            echo "YA";
                                                        }
                                                      else{
                                                            echo "TIDAK";
                                        ...
                                        <div class="panel-body list-group">
                                           <div class="panel-body">
                                            <table class="table table-hover">
                                                <tbody>
                                                    <tr>
                                                        <td class="col-md-2"><span class="fa fa-user">Username</span></td>
                                                        <td><?php echo $periksa['username'];?></td>
                                                    </tr>
                                                      <tr>
                                ...
                                <div class="col-md-12">
                                        ...
                                        <p>Keterangan Nilai:</p>
                                           <table>
                                           <tr>
                                                <td class="col-md-2">Rendah</td>
                                                <td>:</td>
                                                <td>1-10</td>
                                           </tr>
                                           <tr>
                                                <td class="col-md-2">Sedang</td>
                                                <td>:</td>
                                                <td>11-20</td>
                                           </tr>
                                           <tr>
                                                <td class="col-md-2">Tinggi</td>
                                                <td>:</td>
                                                <td>21-100</td>
                                           </tr>
                                        ...
                                        <div class="panel-body">
                                        <?php if($max_z_score=='Tingkat Risiko Rendah')
                                            {
                                                echo "<ul>";
                                                echo "<li>Konsultasi kan ke Dokter Spesialis</li>";
                                                echo "<li>Pola makan sehat</li>";
                                                echo "<li>Hindari stres</li>";
                                                echo "<li>Olahraga teratur</li>";
                                                echo "<li>Konsumsi antioksidan</li>";
                                                echo "<li>Mencegah Hipertensi</li>";
                                                echo "<li>Mencegah Obesitas</li>";
                                                echo "<li> Apabila Merokok, berhenti Merokok</li>";
                                                echo "</ul>";
                                            }elseif($max_z_score=='Tingkat Risiko Sedang')
                                            {
                                                echo "<ul>";
                                                echo "<li>Konsultasi kan ke Dokter Spesialis</li>";
                                                echo "<li>Melakukan Pengecekan kadar kolesterol (HDL, LDL)</li>";
                                                echo "<li> Apabila Merokok, berhenti Merokok</li>";
                                                echo "<li> Melakukan pengecekan Echocardiografi</li>";
                                                echo "</ul>";
                                            }elseif($max_z_score=='Tingkat Risiko Tinggi'){
                                                echo "<ul>";
                                                echo "<li>Konsultasi kan ke Dokter Spesialis</li>";
                                                echo "<li>Apabila Merokok, berhenti Merokok</li>";
                                                echo "<li>Melakukan Pengecekan kadar kolesterol (HDL, LDL)</li>";
                                                echo "<li>Melakukan pengecekan Echocardiografi</li>";
                                                echo "<li>Pemeriksaan X-Ray</li>";
                                                echo "<li>CT dan MRI scan</li>";
                                                echo "</ul>";
                                            }            
                                        ;?>                   
