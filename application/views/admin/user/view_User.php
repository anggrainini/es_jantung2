                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">                                    
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href="<?php echo base_url(); ?>admin/User/edit_User/?username=<?php echo $User['username'];?>" target="_parent">
                                            <button class="btn btn-info btn-rounded btn-block"><span class="fa fa-edit"></span>Edit User</button>
                                            </a>
                                        </div>
                                          <div class="col-md-6">
                                            <a href="<?php echo base_url(); ?>admin/User/edit_password?username=<?php echo $User['username'];?>" target="_parent">
