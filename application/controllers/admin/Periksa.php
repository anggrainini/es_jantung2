...
class Periksa extends MY_Controller {
	...
	public function add_periksa(){
		...
		if(!empty($cek) && $stts=='admin')
        {
				...
				if($this->form_validation->run()==FALSE)
				{
					...
					$inside['content']=$this->load->view('admin/periksa/add_periksa',$data, TRUE);
			 	...
			 	else
				{
					...
					redirect("admin/periksa/list_periksa","refresh");
	...
	public function list_periksa(){
		...
		if(!empty($cek) && $stts=='admin')
        {
			...
			$data['data_user'] = $this->Simple_CRUD->getAllData("tb_user");
			$inside['content']=$this->load->view('admin/periksa/list_periksa',$data, TRUE);
			$this->load->view('admin/layout',$inside);
		}
		else
        {
	...
	public function hapus_periksa(){
		...
		if(!empty($cek) && $stts=='admin')
		{
			...
			header('location:'.base_url().'admin/periksa/list_periksa');
		}
		else
		{
			 header('location:'.base_url().'global/login/log');
	...
	public function edit_periksa(){
		...
		if(!empty($cek) && $stts=='admin')
        {
			...
			$inside['content']=$this->load->view('admin/periksa/edit_periksa',$data, TRUE);
			$this->load->view('admin/layout',$inside);
		}
		else
        {
 	...
 	public function hasil_periksa(){
		...
		if(!empty($cek) && $stts=='admin')
        {
			...
			$inside['content']=$this->load->view('admin/periksa/view_hasil',$data, TRUE);
			$this->load->view('admin/layout',$inside);
		}
		else
        {
