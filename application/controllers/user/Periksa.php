...
class Periksa extends MY_Controller {
	...
	public function add_periksa(){
        ...
        {
				$this->form_validation->set_rules('var_HT', 'var_HT', 'required');
				...
				if($this->form_validation->run()==FALSE)
				{
					...
					$inside['content']=$this->load->view('user/periksa/add_periksa',$data, TRUE);
			 	...
			 	else
				{
					...
					redirect("user/periksa/list_periksa","refresh");
	...
	public function list_periksa(){
		...
		if(!empty($cek) && $stts=='user')
        {
			...
			$data['data_periksa'] = $this->Periksa_model->get_dengan_where_all('tb_periksa','username', $username);
			$data['data_user'] = $this->Simple_CRUD->getAllData("tb_user");
			$inside['content']=$this->load->view('user/periksa/list_periksa',$data, TRUE);
			$this->load->view('user/layout',$inside);
		}
		else
        {
	...
	public function hapus_periksa(){
		...
		if(!empty($cek) && $stts=='user')
		{
			...
			header('location:'.base_url().'user/periksa/list_periksa');
		}
		else
		{
			 header('location:'.base_url().'global/login/log');
	...
	public function edit_periksa(){
		...
		if(!empty($cek) && $stts=='user')
        {
			...
			$inside['content']=$this->load->view('user/periksa/edit_periksa',$data, TRUE);
			$this->load->view('user/layout',$inside);
		}
		else
        {
 	...
 	public function hasil_periksa(){
		...
		if(!empty($cek) && $stts=='user')
        {
			...
			$inside['content']=$this->load->view('user/periksa/view_hasil',$data, TRUE);
			$this->load->view('user/layout',$inside);
		}
		else
        {
